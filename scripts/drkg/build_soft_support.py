...
BACKBONE_READY_ROOT = SETTING_DIR / "softfuse_ready"

SUPPORT_ROOT = SETTING_DIR / "support_features"
SOFT_ROOT = SETTING_DIR / "soft_support"
E2E_SOFT_ROOT = SETTING_DIR / "e2e_soft_support_ready"
...
def write_report(summary: dict[str, Any], source: str):
    ...
    lines = []
    lines.append(f"# DRKG soft support ({source})")
    lines.append("")
