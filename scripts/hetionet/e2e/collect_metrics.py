...
ROOT = Path(".")
RESULT_ROOT = ROOT / "outputs" / "hetionet" / "e2e_hetionet"
REPORT_DIR = ROOT / "outputs" / "hetionet" / "reports"
SUMMARY_PATH = ROOT / "outputs" / "hetionet" / "hetionet_e2e_summary.json"
REPORT_PATH = REPORT_DIR / "day7_hetionet_e2e_summary.md"

ROWS = {
    "backbone_raw": "dataset/setting_d_hetionet/softfuse_ready",
    "soft_support_raw": "dataset/setting_d_hetionet/e2e_soft_support_ready",
    "fuzzy_retrieval_main": "dataset/setting_d_hetionet/e2e_fuzzy_retrieval_ready",
}
...
def write_report(summary: dict[str, Any]) -> None:
    lines = []
    lines.append("# Hetionet E2E summary")
    lines.append("")
